...
import 'package:testmoi/common/genders.dart';
...
import 'package:testmoi/utils/verification/date_regexp.dart';
import 'package:testmoi/utils/verification/email_regexp.dart';
import 'package:testmoi/utils/verification/phone_regexp.dart';
import 'package:testmoi/widgets/button/primary_button.dart';
import 'package:testmoi/widgets/button/secondary_button.dart';
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (value) => userProvider.setStreet(value),
                            validator: (value) {
                              if (value!.isEmpty) {
                                return "This field is required";
                              } else {
                        ...
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (value) => userProvider.setCity(value),
                            validator: (value) {
                              if (value!.isEmpty) {
                                return "This field is required";
                              } else {
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (value) => userProvider.setState(value),
                            keyboardType: TextInputType.name,
                            validator: (value) {
                              if (value!.isEmpty) {
                                return "This field is required";
